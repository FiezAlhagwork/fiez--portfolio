                ...
                <ul className="md:flex hidden justify-center items-center my-4 gap-2">
                  {SocialMeda.map((data) => {
                    return (
                      <SocialMedi
                        key={data.id}
                        className={`p-4 rounded-md border border-solid border-gray-500 ${
                          mode === true
        ...
        <div className=" col-span-4 md:col-span-8 px-10 lg:px-0 lg:pr-3 mt-6 lg:mt-0   ">
          <h1 className="lg:text-6xl text-4xl mt-3  ">
            ...
            <span className=" mb-2">
              <span
                className={`${
                  mode === true ? "borders" : "border border-solid border-black"
          ...
          <div className="flex lg:flex-row flex-col gap-10 mt-20 ">
            ...
            <div className="flex justify-center items-center">
              <button
                className={`${
                  mode === true
                    ? " border-[#fff] hover:text-black hover:bg-[#fff]"
                    : "border-black hover:text-[#fff] hover:bg-black shadow-lg"
                } outline-none border border-solid  px-10 py-3 font-medium text-md transition-all duration-300   rounded-md`}
              >
                Download CV
              </button>
            </div>
